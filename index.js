  ...
  const initUser = () => {
    ...
    return (
      <div>
        ...
        <button onClick={deposit3}> 3 ETH</button><br/>
        
        <label>Withdraw : </label>
        <button onClick={withdraw}> 1 ETH</button>
        <button onClick={withdraw2}> 2 ETH</button>
        <button onClick={withdraw3}> 3 ETH</button><br/><br/>

        <label>ETH Multiplier: </label>
        ...
        <label>ETH Divider : </label>
        <button onClick={divideValue}> by half</button>
      </div>
    );
  };
